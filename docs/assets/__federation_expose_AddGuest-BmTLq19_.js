...
const _hoisted_5 = { class: "input input-bordered flex items-center gap-2 my-2 w-full" };
const _hoisted_6 = { class: "input input-bordered flex items-center gap-2 my-2 w-full" };
  ...
  return (_openBlock(), _createElementBlock("div", null, [
    _createElementVNode("div", _hoisted_1, [
      _createElementVNode("div", _hoisted_2, [
        _cache[6] || (_cache[6] = _createElementVNode("h2", { class: "card-title text-center" }, "Add Guest", -1)),
        _createElementVNode("form", {
          onSubmit: _cache[4] || (_cache[4] = _withModifiers((...args) => ($options.handleAddGuest && $options.handleAddGuest(...args)), ["prevent"]))
        }, [
          ...
          _cache[5] || (_cache[5] = _createElementVNode("div", { class: "card-actions justify-end" }, [
...
const AddGuest = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { AddGuest as default };
