...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-x28ksfzk.js', import.meta.url).href),import:true},'vuex':{get:()=>()=>__federation_import(new URL('__federation_shared_vuex-CZqUMuIH.js', import.meta.url).href),import:true},'axios':{get:()=>()=>__federation_import(new URL('__federation_shared_axios-CfVooqbP.js', import.meta.url).href),import:true}};
